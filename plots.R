...
p1 = p
ggsave(paste("dayWH", extension, sep=""), width = width, height = height, units = "cm")

p2 <- p %+% droplevels(subset(sumDays2, panel=="D40JA" | panel=="D40LG")) 
ggsave(paste("dayWHD40", extension, sep=""), width = width, height = height, units = "cm")

p2 <- p %+% droplevels(subset(sumDays2, panel=="D90JA" | panel=="D90LG"))
ggsave(paste("dayWHD90", extension, sep=""), width = width, height = height, units = "cm")

p2 <- p %+% droplevels(subset(sumDays2, panel=="D13JA" | panel=="D13LG"))
ggsave(paste("dayWHD13", extension, sep=""), width = width, height = height, units = "cm")

p2 <- p %+% droplevels(subset(sumDays2, panel=="A13JA" | panel=="A13LG"))
ggsave(paste("dayWHA13", extension, sep=""), width = width, height = height, units = "cm")

p2 <- p %+% droplevels(subset(sumDays2, panel=="R13JA" | panel=="R13LG"))
ggsave(paste("dayWHR13", extension, sep=""), width = width, height = height, units = "cm")
...
#     scale_color_manual(values = wes_palette("BottleRocket1", 6)) +
#     theme_minimal() + xlab("Day") + ylab("kWh") + baseTitle
